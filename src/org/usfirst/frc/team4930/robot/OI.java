...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("ArmUp", new ArmUp());           //puts a button on the dash for ArmUp

        SmartDashboard.putData("ArmDown", new ArmDown());       //puts a button on the dash for ArmDown
